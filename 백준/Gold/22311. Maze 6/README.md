# [Gold IV] Maze 6 - 22311 

[문제 링크](https://www.acmicpc.net/problem/22311) 
...
<p>The file <a href="https://upload.acmicpc.net/5daf50c5-cc3a-45ae-bf5c-365bda75e6df/">field6.txt</a> represents a field of size 11x11. Create a maze for this field named <code>maze6.txt</code> that has a shortest path from the entrance to the core of length P. Your score for this subtask will be the minimum of 11 and 10<sup>P/54</sup>.</p>
